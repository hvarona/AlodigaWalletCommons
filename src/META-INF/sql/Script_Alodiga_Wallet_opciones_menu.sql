...
(8,4,2,'Gesti贸n  Reportes','Gesti贸n  Reportes');
...
INSERT INTO `alodigaWallet`.`collection_type` (`id`, `description`, `countryId`) VALUES ('5', 'REGISTRO DE INFORMACI脫N FISCAL', '1');
INSERT INTO `alodigaWallet`.`collection_type` (`id`, `description`, `countryId`) VALUES ('6', 'REGISTRO MERCANTIL', '1');
INSERT INTO `alodigaWallet`.`collection_type` (`id`, `description`, `countryId`) VALUES ('7', 'ACTA DE CONSTITUCI脫N DE LA EMPRESA', '1');
...
-- Agregar opciones del menu Aprobaci贸n Retiro Manual
-- author: Lulymar Gutierrez
-- Fecha: 23/07/2020
...
INSERT INTO `permission_data` (`id`,`permissionId`,`languageId`,`alias`,`description`) 
VALUES (154,77,2,'Lista Aprobaci贸n Retiro Manual','Lista Aprobaci贸n Retiro Manual');
INSERT INTO `permission_data` (`id`,`permissionId`,`languageId`,`alias`,`description`) 
VALUES (155,78,1,'Add Manual Withdrawal Approval','Add Manual Withdrawal Approval');
INSERT INTO `permission_data` (`id`,`permissionId`,`languageId`,`alias`,`description`) 
VALUES (156,78,2,'Agregar Aprobaci贸n Retiro Manual','Agregar Aprobaci贸n Retiro Manual');
INSERT INTO `permission_data` (`id`,`permissionId`,`languageId`,`alias`,`description`) 
VALUES (157,79,1,'Edit Manual Withdrawal Approval','Edit Manual Withdrawal Approval');
INSERT INTO `permission_data` (`id`,`permissionId`,`languageId`,`alias`,`description`) 
VALUES (158,79,2,'Editar Aprobaci贸n Retiro Manual','Editar Aprobaci贸n Retiro Manual');
INSERT INTO `permission_data` (`id`,`permissionId`,`languageId`,`alias`,`description`) 
VALUES (159,80,1,'View Manual Withdrawal Approval','View Manual Withdrawal Approval');
INSERT INTO `permission_data` (`id`,`permissionId`,`languageId`,`alias`,`description`) 
VALUES (160,80,2,'Ver Aprobaci贸n Retiro Manual','Ver Aprobaci贸n Retiro Manual');
...
-- opciones del menu Listar Prerelaciones Estatus Afiliaci髇
-- author: Yamelis Almea
-- Fecha: 07/08/2020
...
INSERT INTO `alodigawallet`.`permission_data` (`id`, `permissionId`, `languageId`, `alias`, `description`) VALUES ('186', '93', '2', 'Listar Prerelaciones Estatus Afiliaci髇', 'Prerelaciones Estatus Afiliaci髇');
